...
const aws = [
    ...
    'ps/jebba/hydro/niger/pd', 'ps/jebba/hydro/niger/status',
    'ps/kainji/hydro/niger/pd', 'ps/kainji/hydro/niger/status',
    ...
    'transamadi/tv',
    'gbaraints/pv', 'gbaraints/status',
    'ps/zungeru/hydro/niger/pd', 'ps/zungeru/hydro/niger/status',
    'taopex/tv', 
